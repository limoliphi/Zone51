...
<body>
    ...
    <form action="" method="post">
        <div>
            ...
            <input class="champ" type="text"  class="pill"placeholder="Red... or blue ?" 15 name="pilule" required value="<?php if(isset($_POST['pilule'])) echo $_POST['pilule']; ?>" />
            <p><?php if(isset($errors['pilule1'])) echo $errors['pilule1']; ?></p>
        </div>
        <div class="button">
            <button class="repo" type="submit">I take the pill</button>
        </div>
